    ...
    while intentos < 5:
        ...
        if director != "Director-64":
            ...
            while True:
                    ...
                    print("3. Modificar")
                    print("4. Eliminar")
                    print("5. Mantenimiento de animales")
                    ...
                    if opcion_menu == "1": ##MENU REGISTRAR
                        ...
                        print("4. Mostrar personal mantenimiento") #done
                    ...
                    if opcion_menu =="4": ##ELIMINAR
                        ...
                        print("\nSeleccionaste la opcion de mantenimiento de animales")
                        id_trabajador=input("Ingresa el ID del trabajador de mantenimiento: ")
                        id=zoo.checar_id_matenimiento(id_trabajador)
                        id = input("Ingresa el ID del animal: ")
                        animal = zoo.checar_id(id=id)
                        proceso= input("Ingresa el proceso que se realizo con el animal: ")
                        ano = int(input("Ingresa el año del proceso: "))
                        mes = int(input("Ingresa el mes del proceso: "))
                        dia = int(input("Ingresa el dia del proceso: "))
                        fecha_proceso = datetime(ano, mes, dia)
                        observaciones = input("Observaciones: ")
                        alimentacion = Alimentacion(proceso=proceso, observaciones=observaciones, fecha_proceso=fecha_proceso)
